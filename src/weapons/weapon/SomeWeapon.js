...
class SomeWeapon extends Phaser.GameObjects.Sprite {
    ...
    constructor(scene) {
        super(scene, 200, 200, 'someWeapon');
    }
    ...
    //Ustawia podnoszacemu info o amunicji- ilosc i typ-
    pickUp(osobaPodnoszaca){}


    //nadaje widzocznosc/ ustawia info o pozostalej aminicji -ilosc i params to albo pojedyncze wartosci albo osoba podnoszacaK
